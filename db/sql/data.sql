...
insert into customer (dni, full_name, credit_card, total_flights, total_lodgings, total_tours, phone_number) VALUES
                                                                                                                 ('VIKI771012HMCRG093', 'Sarah Johnson', '6473-9486-9372-0921', 0, 0, 0, '954-745-86-43'),
                                                                                                                 ('BBMB771012HMCRR022', 'James Anderson', '4463-3326-9980-5454', 0, 0, 0, '954-833-22-22'),
                                                                                                                 ('WALA771012HCRGR054', 'Michael Smith', '6677-5244-94572-0165', 0, 0, 0, '954-244-11-54'),
                                                                                                                 ('GOTW771012HMRGR087', 'Emily Davis', '6766-9484-9442-0222', 0, 0, 0, '954-783-32-11');

insert into reservation (id_reservation, date_reservation,  hotel_id, customer_id, date_start, date_end, total_days, price) VALUES
                                                                                                                    ('12345678-1234-5678-1234-567812345678', now(), 1, 'BBMB771012HMCRR022', '2023-08-01', '2020-01-07', 7, 77.00),
                                                                                                                    ('22345678-1234-5678-1234-567812345678', now(), 2, 'VIKI771012HMCRG093', '2023-08-01', '2020-01-07', 7, 22.00),
                                                                                                                    ('32345678-1234-5678-1234-567812345678', now(), 3, 'VIKI771012HMCRG093', '2023-08-01', '2024-08-01', 4, 112.00),
                                                                                                                    ('52345678-1234-5678-1234-567812345678', now(), 3, 'VIKI771012HMCRG093', '2023-08-12', '2020-01-14', 2, 74.00);

insert into ticket (id_ticket, price, fly_id, customer_id, departure_date, arrival_date, purchase_date) VALUES
                                                                                                     ('12345678-1234-5678-2236-567812345678', 330.05, 1, 'BBMB771012HMCRR022', '2023-08-01 14:00:00', '2024-08-01 16:00:00',now()),
                                                                                                     ('22345678-1234-5678-3235-567812345678', 220.33, 1, 'VIKI771012HMCRG093', '2023-08-01 14:00:00', '2024-08-01 16:00:00', now()),
                                                                                                     ('32345678-1234-5678-4234-567812345678', 320.00, 4, 'VIKI771012HMCRG093', '2023-08-01 12:00:00', '2024-08-01 15:00:00', now()),
                                                                                                     ('42345678-1234-5678-5233-567812345678', 560.77, 7, 'VIKI771012HMCRG093', '2023-08-12 20:00:00', '2020-01-14 22:00:00', now());
